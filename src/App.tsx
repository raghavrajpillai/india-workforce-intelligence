...
export default function App() {
  return (
    <HashRouter>
      <Routes>
        <Route path="/" element={<><Nav /><HomePage /><Disclaimer /></>} />
        <Route path="/explore" element={<ExplorePage />} />
        <Route path="/methodology" element={<><Nav /><MethodologyPage /><Disclaimer /></>} />
        <Route path="/about" element={<><Nav /><AboutPage /><Disclaimer /></>} />
